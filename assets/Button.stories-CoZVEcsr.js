import{n as e}from"./chunk-DnJy8xQt.js";import{t}from"./jsx-runtime-DxP0NviS.js";import{n,t as r}from"./Button-DTKtInX7.js";var i,a,o,s,c,l,u,d,f,p,m,h,g,_;e((()=>{n(),i=t(),{fn:a}=__STORYBOOK_MODULE_TEST__,o={title:`Molecules/Buttons`,component:r,parameters:{layout:`centered`},tags:[`autodocs`],argTypes:{hierarchy:{control:`select`,options:[`primary`,`secondary`,`link-grey`,`link-color`]},size:{control:`select`,options:[`small`,`medium`,`large`,`xlarge`]},icon:{control:`select`,options:[`none`,`left`,`right`,`only`,`both`]},destructive:{control:`boolean`},state:{control:`select`,options:[`default`,`focus`,`disabled`]}},args:{onClick:a()}},s={args:{hierarchy:`primary`,size:`small`,icon:`none`,destructive:!1,state:`default`,label:`Button CTA`}},c={render:()=>(0,i.jsxs)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:`var(--size_3)`},children:[(0,i.jsx)(r,{hierarchy:`primary`,size:`medium`,label:`Primary`}),(0,i.jsx)(r,{hierarchy:`secondary`,size:`medium`,label:`Secondary`}),(0,i.jsx)(r,{hierarchy:`link-grey`,size:`medium`,label:`Link Grey`}),(0,i.jsx)(r,{hierarchy:`link-color`,size:`medium`,label:`Link Color`})]})},l={render:()=>(0,i.jsxs)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:`var(--size_5)`,alignItems:`center`},children:[(0,i.jsx)(r,{hierarchy:`primary`,destructive:!0,size:`medium`,label:`Primary`}),(0,i.jsx)(r,{hierarchy:`link-color`,destructive:!0,size:`medium`,label:`Link`})]})},u={render:()=>(0,i.jsxs)(`div`,{style:{display:`flex`,flexWrap:`wrap`,alignItems:`center`,gap:`var(--size_3)`},children:[(0,i.jsx)(r,{hierarchy:`primary`,size:`small`,label:`Small`}),(0,i.jsx)(r,{hierarchy:`primary`,size:`medium`,label:`Medium`}),(0,i.jsx)(r,{hierarchy:`primary`,size:`large`,label:`Large`}),(0,i.jsx)(r,{hierarchy:`primary`,size:`xlarge`,label:`Xlarge`})]})},d={render:()=>(0,i.jsxs)(`div`,{style:{display:`flex`,flexWrap:`wrap`,alignItems:`center`,gap:`var(--size_3)`},children:[(0,i.jsx)(r,{hierarchy:`primary`,size:`medium`,label:`Left Icon`,icon:`left`}),(0,i.jsx)(r,{hierarchy:`primary`,size:`medium`,label:`Right Icon`,icon:`right`}),(0,i.jsx)(r,{hierarchy:`primary`,size:`medium`,icon:`only`}),(0,i.jsx)(r,{hierarchy:`primary`,size:`medium`,label:`Both Icons`,icon:`both`})]})},f={render:()=>(0,i.jsxs)(`div`,{style:{display:`flex`,flexWrap:`wrap`,gap:`var(--size_4)`},children:[(0,i.jsx)(r,{hierarchy:`primary`,size:`medium`,label:`Primary Focus`,state:`focus`}),(0,i.jsx)(r,{hierarchy:`secondary`,size:`medium`,label:`Secondary Focus`,state:`focus`}),(0,i.jsx)(r,{hierarchy:`primary`,destructive:!0,size:`medium`,label:`Destructive Focus`,state:`focus`})]})},p={args:{hierarchy:`primary`,size:`medium`,label:`Button CTA`,icon:`left`}},m={args:{hierarchy:`primary`,size:`medium`,label:`Button CTA`,icon:`right`}},h={args:{hierarchy:`primary`,size:`medium`,icon:`only`}},g={render:()=>(0,i.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`24px`},children:[(0,i.jsxs)(`div`,{style:{display:`flex`,gap:`16px`,flexWrap:`wrap`},children:[(0,i.jsx)(r,{hierarchy:`primary`,size:`small`,label:`Small`,state:`disabled`}),(0,i.jsx)(r,{hierarchy:`primary`,size:`medium`,label:`Medium`,state:`disabled`}),(0,i.jsx)(r,{hierarchy:`primary`,size:`large`,label:`Large`,state:`disabled`}),(0,i.jsx)(r,{hierarchy:`primary`,size:`xlarge`,label:`Xlarge`,state:`disabled`})]}),(0,i.jsxs)(`div`,{style:{display:`flex`,gap:`16px`,flexWrap:`wrap`},children:[(0,i.jsx)(r,{hierarchy:`primary`,size:`medium`,label:`Left Icon`,icon:`left`,state:`disabled`}),(0,i.jsx)(r,{hierarchy:`primary`,size:`medium`,label:`Right Icon`,icon:`right`,state:`disabled`}),(0,i.jsx)(r,{hierarchy:`primary`,size:`medium`,icon:`only`,state:`disabled`})]}),(0,i.jsxs)(`div`,{style:{display:`flex`,gap:`16px`,flexWrap:`wrap`,alignItems:`center`},children:[(0,i.jsx)(r,{hierarchy:`primary`,destructive:!0,size:`medium`,label:`Button CTA`,state:`disabled`}),(0,i.jsx)(r,{hierarchy:`link-color`,destructive:!0,size:`medium`,label:`Button CTA`,state:`disabled`})]})]})},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    hierarchy: 'primary',
    size: 'small',
    icon: 'none',
  ...
  render: () => <div style={{
    ...
    gap: 'var(--size_3)'
      ...
      <Button hierarchy="primary" size="medium" label="Both Icons" icon="both" />
    </div>
