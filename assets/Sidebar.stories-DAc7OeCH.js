import{n as e}from"./chunk-DnJy8xQt.js";import{t}from"./jsx-runtime-DxP0NviS.js";import{n,r,t as i}from"./Sidebar-BM9L_06s.js";var a,o,s,c,l,u,d;e((()=>{r(),a=t(),{fn:o}=__STORYBOOK_MODULE_TEST__,s={title:`Organisms/Sidebar`,component:i,parameters:{layout:`fullscreen`,docs:{description:{component:`Sidebar organism with expanded and collapsed layouts, reusable sidebar menu items, active/focus/disabled states, store switcher, account area, and quick actions.`}}},tags:[`autodocs`],argTypes:{type:{control:`select`,options:[`expanded`,`collapsed`]},activeItemId:{control:`text`},sections:{control:`object`}},args:{onItemChange:o(),onPreview:o(),onLogout:o()}},c={render:e=>(0,a.jsx)(`div`,{className:`flex min-h-screen items-start justify-center gap-10 bg-neutral-100 p-8`,children:(0,a.jsx)(i,{...e})}),args:{type:`expanded`,activeItemId:`active-theme`}},l={render:()=>(0,a.jsxs)(`div`,{className:`flex min-h-screen items-start justify-center gap-10 bg-neutral-100 p-8`,children:[(0,a.jsx)(i,{type:`expanded`}),(0,a.jsx)(i,{type:`collapsed`})]})},u={render:()=>(0,a.jsxs)(`div`,{className:`grid grid-cols-[max-content_max-content] gap-x-16 gap-y-5 p-5`,children:[[`default`,`hover`,`focused`,`disabled`].map(e=>(0,a.jsx)(n,{icon:`drag`,label:`Custom Blocks #1`,state:e},`expanded-default-${e}`)),[`default`,`hover`,`focused`,`disabled`].map(e=>(0,a.jsx)(n,{icon:`drag`,label:`Custom Blocks #1`,pressed:!0,state:e},`expanded-pressed-${e}`)),[`default`,`hover`,`focused`,`disabled`].map(e=>(0,a.jsx)(n,{icon:`drag`,label:`Custom Blocks #1`,state:e,type:`collapsed`},`collapsed-default-${e}`)),[`default`,`hover`,`focused`,`disabled`].map(e=>(0,a.jsx)(n,{icon:`drag`,label:`Custom Blocks #1`,pressed:!0,state:e,type:`collapsed`},`collapsed-pressed-${e}`))]}),parameters:{layout:`centered`}},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  render: args => <div className="flex min-h-screen items-start justify-center gap-10 bg-neutral-100 p-8">
      <Sidebar {...args} />
    </div>,
  args: {
    type: 'expanded',
